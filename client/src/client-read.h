 ...
 * rpc calls. */
typedef struct {
    unsigned id;          /* unique id for this set of read requests */
    unsigned n_reads;     /* number of read requests */
    unsigned n_complete;  /* number of completed requests */
    unsigned n_error;     /* number of requests that encountered errors */
